<template>
  <aside class="sidebar sidebar-guru" :class="{ 'sidebar-collapsed': isCollapsed }">
    <div class="sidebar-header">
      <div class="brand">
        <span class="brand-icon">👨‍🏫</span>
        <span class="brand-title" v-show="!isCollapsed">E-Learning Guru</span>
      </div>
      <button 
        class="collapse-btn" 
    ...
    <nav class="sidebar-nav">
      <ul class="nav-list">
        ...
        <li>
          ...
          <transition name="submenu">
            <ul class="submenu" v-if="dropdowns.materi && !isCollapsed">
              <li>
                <router-link to="/guru/materi" class="submenu-link" @click="handleNavClick">
                  <span class="submenu-icon">📖</span>
                  <span>Lihat Materi</span>
                </router-link>
              </li>
              <li>
                <router-link to="/guru/materi/tambah" class="submenu-link" @click="handleNavClick">
                  <span class="submenu-icon">➕</span>
                  <span>Tambah Materi</span>
                </router-link>
              </li>
              <li>
                <router-link to="/guru/materi/edit" class="submenu-link" @click="handleNavClick">
        ...
        <li>
          ...
          <transition name="submenu">
            <ul class="submenu" v-if="dropdowns.tugas && !isCollapsed">
              <li>
                <router-link to="/guru/tugas" class="submenu-link" @click="handleNavClick">
                  <span class="submenu-icon">📝</span>
                  <span>Lihat Tugas</span>
                </router-link>
              </li>
              <li>
                <router-link to="/guru/tugas/buat" class="submenu-link" @click="handleNavClick">
                  <span class="submenu-icon">➕</span>
                  <span>Buat Tugas</span>
                </router-link>
              </li>
              <li>
                <router-link to="/guru/tugas/nilai" class="submenu-link" @click="handleNavClick">
                  <span class="submenu-icon">📊</span>
        ...
        <li>
          <div 
            class="nav-link dropdown-link" 
            @click="toggleDropdown('quis')"
            :class="{ 'active': activeDropdown === 'quis' }"
          >
            <span class="nav-icon">✏️</span>
            <span class="nav-text" v-show="!isCollapsed">Quis</span>
            <span class="dropdown-arrow" :class="{ 'rotated': dropdowns.quis }" v-show="!isCollapsed">▼</span>
            <span class="nav-tooltip" v-show="isCollapsed">Quis</span>
          </div>
          <transition name="submenu">
            <ul class="submenu" v-if="dropdowns.quis && !isCollapsed">
              <li>
                <router-link to="/guru/quis" class="submenu-link" @click="handleNavClick">
                  <span class="submenu-icon">📝</span>
                  <span>Lihat Quis</span>
                </router-link>
              </li>
              <li>
                <router-link to="/guru/quis/buat" class="submenu-link" @click="handleNavClick">
                  <span class="submenu-icon">➕</span>
                  <span>Buat Quis</span>
                </router-link>
              </li>
              <li>
                <router-link to="/guru/quis/nilai" class="submenu-link" @click="handleNavClick">
                  <span class="submenu-icon">📊</span>
                  <span>Nilai Quis</span>
                </router-link>
              </li>
            </ul>
          </transition>
        ...
        <li>
          ...
          >
            <span class="nav-icon">👥</span>
            <span class="nav-text" v-show="!isCollapsed">Kelas</span>
