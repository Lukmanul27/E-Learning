        ...
        <div class="system-overview">
          <div class="overview-card">
            ...
            <div class="card-content">
              <h3>Server Status</h3>
              <p class="status-text" :class="serverStatus.class">{{ serverStatus.text }}</p>
            </div>
          </div>
          ...
          <div class="overview-card">
            ...
            <div class="card-content">
              <h3>Storage</h3>
              <p class="status-text">{{ storageUsage }}% used</p>
            </div>
          </div>
          ...
          <div class="overview-card">
            ...
            <div class="card-content">
              <h3>Active Users</h3>
              <p class="status-text">{{ activeUsers }} online</p>
            </div>
          </div>
          ...
          <div class="overview-card">
            ...
            <div class="card-content">
              <h3>Performance</h3>
              <p class="status-text" :class="performanceStatus.class">{{ performanceStatus.text }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="system-actions">
          <div class="action-section">
            ...
            <div class="action-buttons">
              <button class="btn-primary" @click="backupSystem">
                💾 Backup System
              </button>
              <button class="btn-secondary" @click="clearLogs">
                🗑️ Clear Logs
              </button>
              <button class="btn-warning" @click="restartSystem">
                🔄 Restart System
              </button>
              <button class="btn-danger" @click="shutdownSystem">
                ⏹️ Shutdown
              </button>
            </div>
          </div>
